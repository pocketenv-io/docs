...
<AccordionGroup>
  ...
  <Accordion title="Fly Sprites" icon="plane">
    Fast micro-VMs via [Fly.io Sprites](https://fly.io/blog/fly-sprites).
...
| Base | Description |
|---|---|
| `openclaw` | General-purpose Linux dev environment (default) |
| `zeroclaw` | Minimal base image |
| `picoclaw` | Ultra-lightweight |
| `nix` | Nix-based environment |
| `claude-code` | Optimized for Claude Code |
| `codex` | Optimized for Codex |
| `opencrust` | Rust development |
